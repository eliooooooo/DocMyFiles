 ...
 * @returns {void}
 */
export async function processMessage(message, listRequest, listRequestMessages, listMessagesSize, totalMessages, ignoredFiles, MAX_TOKENS) {
 ...
 * @returns {void}
 */
export async function sendRequest(projectPath, messagesList, messageStack, MAX_TOKENS, TOKENS_PER_MINUTES) {
